...
def main() -> None:
    ...
    parser.add_argument(
        "--raw-csv",
        type=str,
        default=str(Path(__file__).resolve().parent / "support_files" / "locat_runtime_benchmark_16k_sparsegrid_r3_raw.csv"),
    )
    parser.add_argument(
        "--out-prefix",
        type=str,
        default=str(Path(__file__).resolve().parent / "support_files" / "locat_runtime_curves_r3"),
    )
